package co.za.ndingujosh.igrama.views.sentencepicker;
...
@PageTitle("Sentence picker")
@Route(value = "pick")
@PermitAll
@Tag("sentencepicker-view")
@JsModule("./views/sentencepicker/sentencepicker-view.ts")
public class SentencepickerView extends LitTemplate implements HasComponents, HasStyle {

    @Id
    private Select<String> sortBy;

    public SentencepickerView() {
        addClassNames("sentencepicker-view", "flex", "flex-col", "h-full");
